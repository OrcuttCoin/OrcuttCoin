...
What is OrcuttCoin?
----------------
OrcuttCoin is a proof-of-Orcutt cyrptocurrency with a token economy tied to the price of one solo Bill Orcutt record.

For the price of one OrcuttCoin, one Bill Orcutt record is purchased and melted in an oven so that no one ever has to listen to it. The proof of destruction is based on the Stellar Social Consensus (SCP) algorithm and stored in an immutable distributed blockchain.
...
[OrcuttCoin](http://zclassic.org/), like [Zcash](https://z.cash/), is an implementation of the "Zerocash" protocol.
...
Where do I begin?
-----------------
We have a guide for joining the main OrcuttCoin network:
https://github.com/z-classic/zclassic/wiki/1.0-User-Guide

### Need Help?

* See the documentation at the [OrcuttCoin Wiki](https://github.com/z-classic/zclassic/wiki)
  for help and more information.
* Ask for help on the [OrcuttCoin](http://zcltalk.tech/index.php) forum.
